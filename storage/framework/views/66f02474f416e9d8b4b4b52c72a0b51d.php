                ...
                <?php if(Route::has('login')): ?>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownId">
                                <a class="dropdown-item" href="<?php echo e(route('admin.index')); ?>">Admin</a>
                                <a class="dropdown-item" href="<?php echo e(route('user.index')); ?>">User</a>
                            </div>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
...
<?php /**PATH D:\laragon\www\LaravelMiddleware\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>